...
define( 'WPCACHEHOME', '/home/lisa360/public_html/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('DB_NAME', '360payments');

/** MySQL database username */
define('DB_USER', 'threesixty_wp');

/** MySQL database password */
define('DB_PASSWORD', 'nHK6x31c9@r2');
